...
export interface paths {
    ...
    "/divisions/{division}": {
        ...
        put?: never;
        post?: never;
        /** Destroy one division */
        delete: operations["divisions.destroy"];
        options?: never;
        head?: never;
        /** Update one division */
    ...
    "/activity-logs": {
        ...
        get: operations["activity-logs.index"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    schemas: {
        ...
        "resources.roles.resource.fetch": {
            ...
            attributes: {
                ...
                /**
                 * createdAt
                 * @example 2026-03-13T11:37:58.000000Z
                 */
                readonly createdAt?: string;
                /**
                 * updatedAt
        ...
        "resources.users.resource.fetch": {
            ...
            attributes: {
                ...
                /**
                 * email
                 * @example club-admin-1@example.org
                 */
                email?: string;
                /**
                 * password
                 * @example $2y$10$0018Jo8OYzbJIUqWncbgD.ouEfAH41dJ0.eqr5Ze4BPhwdrGnpJQK
                 */
                password?: string;
                /**
                 * preferredLocale
                ...
                /**
                 * createdAt
                 * @example 2026-03-13T11:38:03.000000Z
                 */
                readonly createdAt?: string;
                /**
                 * updatedAt
            ...
            relationships?: {
                ...
                roles?: {
                    readonly links?: {
                        /**
                         * related
                         * @example http://api.verein.localhost/api/v1/roles/2
                         */
                        related?: string;
                        /**
                         * self
        ...
        /** Resource/Activity-log/Fetch */
        "resources.activity-logs.resource.fetch": {
            /**
             * type
            ...
            attributes: {
                ...
                /**
                 * createdAt
                 * @example 2026-07-16T13:48:36.000000Z
                 */
                readonly createdAt?: string;
            };
        };
...
export interface operations {
    ...
    "membership-types.index": {
        parameters: {
            query?: {
                ...
                /** @description The page number for paginated results */
                "page[number]"?: number;
                sort?: ("id" | "-id" | "title" | "-title" | "sortOrder" | "-sortOrder" | "createdAt" | "-createdAt" | "updatedAt" | "-updatedAt")[];
                /** @description A list of ids to filter by. */
                "filter[id]"?: string[];
    ...
    "divisions.index": {
        parameters: {
            query?: {
                ...
                /** @description The page number for paginated results */
                "page[number]"?: number;
                sort?: ("id" | "-id" | "title" | "-title" | "createdAt" | "-createdAt" | "updatedAt" | "-updatedAt")[];
                /** @description A list of ids to filter by. */
                "filter[id]"?: string[];
                /** @description Filters the records */
                "filter[query]"?: string;
    ...
    "receipts.index": {
        parameters: {
            query?: {
                ...
                /** @description The page number for paginated results */
                "page[number]"?: number;
                sort?: ("id" | "-id" | "bookingDate" | "-bookingDate" | "amount" | "-amount" | "amount" | "-amount")[];
                /** @description A list of ids to filter by. */
                "filter[id]"?: string[];
    ...
    "activity-logs.index": {
        ...
        requestBody?: never;
        responses: {
            /** @description Index activity-logs */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/vnd.api+json": {
                        ...
                        data: components["schemas"]["resources.activity-logs.resource.fetch"][];
                    };
                };
            };
            400: components["responses"]["400"];
